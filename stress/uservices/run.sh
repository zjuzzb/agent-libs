...
#	docker run -d --name=srvc_node7 --link srvc_node2:srvc_next0 --link srvc_node6:srvc_next1 -e ROLE=root -e NAME=srvc_node7 -e NC=2 -e CPU_OPS=40000 us

#	docker run -d --name=srvc_node6 -e ROLE=node -e NAME=srvc_node6 -e CPU_OPS=15000 -e IO_OPS=1000 -e NC=0 us
