...
public:
	...
	virtual void on_connect(sinsp_evt *evt, uint8_t family, uint8_t* packed_data) = 0;
	virtual void on_accept(sinsp_evt *evt) = 0;
//	virtual void on_close(sinsp_evt *evt, int64_t tid, int64_t fd, char *data, uint32_t original_len, uint32_t len) = 0;
};
