 ...
 */
class post_aggregated_metrics_rest_request_handler : public librest::rest_request_handler
{
public:
	post_aggregated_metrics_rest_request_handler();
	...
	static post_aggregated_metrics_rest_request_handler* create();
