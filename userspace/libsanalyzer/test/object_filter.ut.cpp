...
TEST(object_filter_test, port_filter_single_against_range)
{
	...
	port_filter<process_filter_args> my_filter(
	    {object_filter_config::port_filter_rule(true, false, 0, 12, ports2)});
	...
	port_filter<process_filter_args> my_filter2(
	    {object_filter_config::port_filter_rule(true, false, 0, 11, ports2)});
	matches = my_filter2.matches(args, exclude, high_priority, &reason);
	EXPECT_EQ(matches, false);

	matches = false;
	// 12 is in range 12->20
	port_filter<process_filter_args> my_filter3(
	    {object_filter_config::port_filter_rule(true, false, 12, 20, ports2)});
...
TEST(object_filter_test, port_filter_single_against_set)
{
	...
	port_filter<process_filter_args> my_filter4(
	    {object_filter_config::port_filter_rule(true, true, 0, 0, ports2)});
	matches = true;
	...
	port_filter<process_filter_args> my_filter5(
	    {object_filter_config::port_filter_rule(true, true, 0, 0, ports2)});
	matches = false;
	reason = "";
...
TEST(object_filter_test, port_filter_multiple_against_range)
{
	...
	port_filter<process_filter_args> my_filter6(
	    {object_filter_config::port_filter_rule(true, false, 20, 100, ports3)});
	...
	port_filter<process_filter_args> my_filter3(
	    {object_filter_config::port_filter_rule(true, false, 12, 20, ports3)});
	matches = my_filter3.matches(args, exclude, high_priority, &reason);
	EXPECT_EQ(matches, true);
	EXPECT_EQ(exclude, false);
	EXPECT_EQ(high_priority, true);
...
TEST(object_filter_test, port_filter_multiple_against_set)
{
	...
	port_filter<process_filter_args> my_filter7(
	    {object_filter_config::port_filter_rule(true, true, 0, 0, ports3)});
...
TEST(object_filter_test, port_filter_include_exclude)
{
	...
	port_filter<process_filter_args> my_filter8(
	    {object_filter_config::port_filter_rule(true, false, 0, 50, ports2),
	...
	process_filter_args null_args(NULL, NULL, NULL, NULL);
	std::set<uint16_t> ports3 = {};
	port_filter<process_filter_args> my_filter(
	    {object_filter_config::port_filter_rule(true, false, 0, 12, ports3)});
...
{
	process_name_filter<process_filter_args> my_filter("process?name");
...
{
	process_cmd_line_filter<process_filter_args> my_filter("fo?");
...
{
	container_name_filter<process_filter_args> my_filter("container?name");
	...
	process_filter_args args(NULL, NULL, &container, NULL);
	matches = my_filter.matches(args, exclude, high_priority, &reason);
	EXPECT_EQ(matches, true);
	EXPECT_EQ(exclude, false);
	EXPECT_EQ(high_priority, true);
...
{
	container_image_filter<process_filter_args> my_filter("container?image");
...
{
	container_label_filter<process_filter_args> my_filter("some_label", "some?value");
...
{
	app_check_filter<process_filter_args> my_filter("some app?check");
	...
	test_helper::clear_app_check(&tinfo);
	test_helper::insert_app_check(&tinfo, "some other app check");
	matches = my_filter.matches(args, exclude, high_priority, &reason);
	EXPECT_EQ(matches, false);
...
TEST(object_filter_test, none_test)
{
	...
	object_filter_config::filter_rule none_filter_rule(
	    "name",
	    true,
	...
	bool matches = my_filter.matches(NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
TEST(object_filter_test, object_filter)
{
	...
	std::set<uint16_t> ports = {12};
	object_filter_config::filter_rule port_filter_rule(
	    "name",
	    true,
	    {object_filter_config::filter_condition(
	    ...
	    object_filter_config::rule_config());
	object_filter_config::filter_rule process_name_filter_rule(
	    "name",
	    true,
	    {object_filter_config::filter_condition(
	        object_filter_config::filter_condition::param_type::process_name,
	        "",
	        "my_process_name",
	        {})},
	    object_filter_config::rule_config());
	object_filter_config::filter_rule process_cmd_line_filter_rule(
	    "name",
	    true,
	    {object_filter_config::filter_condition(
	        object_filter_config::filter_condition::param_type::process_cmdline,
	        "",
	        "my_process_cmd_line",
	        {})},
	    object_filter_config::rule_config());
	object_filter_config::filter_rule container_name_filter_rule(
	    "name",
	    true,
	    {object_filter_config::filter_condition(
	        object_filter_config::filter_condition::param_type::container_name,
	        "",
	        "my_container_name",
	        {})},
	    object_filter_config::rule_config());
	object_filter_config::filter_rule container_image_filter_rule(
	    "name",
	    true,
	    {object_filter_config::filter_condition(
	        object_filter_config::filter_condition::param_type::container_image,
	        "",
	        "my_container_image",
	        {})},
	    object_filter_config::rule_config());
	object_filter_config::filter_rule container_label_filter_rule(
	    "name",
	    true,
	    {object_filter_config::filter_condition(
	        ...
	        {})},
	    object_filter_config::rule_config());
	object_filter_config::filter_rule tag_filter_rule(
	    "name",
	    true,
	    {object_filter_config::filter_condition(
	...
	object_filter_config::filter_rule app_check_filter_rule(
	    ...
	    {object_filter_config::filter_condition(
	        ...
	        {})},
	    object_filter_config::rule_config());
	object_filter_config::filter_rule all_filter_rule(
	    "name",
	    true,
	    {object_filter_config::filter_condition(
	...
	matches = my_filter.matches(&tinfo, NULL, NULL, NULL, &generic_match, &rule_num, NULL);
	EXPECT_EQ(matches, true);
	...
	matches = false;
	generic_match = true;
	matches = my_filter.matches(NULL, NULL, &container, NULL, &generic_match, &rule_num, NULL);
	EXPECT_EQ(matches, true);
	EXPECT_EQ(generic_match, false);
	EXPECT_EQ(rule_num->m_cond[0].m_param_type,
	          object_filter_config::filter_condition::param_type::container_name);
	...
	test_helper::insert_app_check(&tinfo, "app check");
	matches = false;
	generic_match = true;
	...
	matches = false;
	generic_match = true;
	matches = my_filter.matches(NULL, NULL, NULL, NULL, &generic_match, &rule_num, NULL);
	EXPECT_EQ(matches, true);
	...
	object_filter_config::filter_rule combo_rule(
	    "name",
	    true,
	    {object_filter_config::filter_condition(
	         object_filter_config::filter_condition::param_type::container_name,
	...
	EXPECT_EQ(rule_num->m_cond[0].m_param_type,
	          object_filter_config::filter_condition::param_type::container_name);
	EXPECT_EQ(rule_num->m_cond[1].m_param_type,
	          object_filter_config::filter_condition::param_type::container_image);
	...
	matches = true;
	matches = my_filter.matches(NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	EXPECT_EQ(matches, true);

	// create a filter with an exclude rule and make sure it works
	object_filter_config::filter_rule exclude_rule(
	    "name",
	    false,
	    {object_filter_config::filter_condition(
	        object_filter_config::filter_condition::param_type::container_name,
...
TEST(object_filter_test, register_annotations)
{
	...
	object_filter_config::filter_rule filter_rule(
	    "name",
	    true,
	    {object_filter_config::filter_condition(
	        object_filter_config::filter_condition::param_type::tag,
...
TEST(object_filter_test, init_from_config)
{
  ...
  - include:
	...
	if (my_data.get_value()[0].m_cond[0].m_param_type ==
	    object_filter_config::filter_condition::param_type::container_name)
	{
		EXPECT_EQ(my_data.get_value()[0].m_cond[0].m_pattern, "my_container_name");
		EXPECT_EQ(my_data.get_value()[0].m_cond[1].m_param_type,
		          object_filter_config::filter_condition::param_type::container_image);
		EXPECT_EQ(my_data.get_value()[0].m_cond[1].m_pattern, "my_container_image");
	}
	else if (my_data.get_value()[0].m_cond[0].m_param_type ==
	         object_filter_config::filter_condition::param_type::container_image)
	{
	...
	EXPECT_EQ(my_data.get_value()[1].m_cond[0].m_param_type,
	          object_filter_config::filter_condition::param_type::all);
	...
	bool matches = true;
	const object_filter_config::filter_rule* rule_num;
	matches = my_filter.matches(NULL, NULL, &container, NULL, NULL, &rule_num, NULL);
	EXPECT_EQ(matches, false);
