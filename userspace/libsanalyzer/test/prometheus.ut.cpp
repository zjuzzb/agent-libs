...
TEST(prometheus_conf_test, defaults)
{
	...
	ASSERT_EQ(1, promscrape_conf::c_promscrape_timeout->get_value());
}
...
prometheus:
  timeout: 20
	...
	ASSERT_EQ(20, promscrape_conf::c_promscrape_timeout->get_value());
}
...
prometheus:
  timeout: 100
	...
	ASSERT_TRUE(config.loaded());
	ASSERT_EQ(60, promscrape_conf::c_promscrape_timeout->get_value());
}
