 ...
 */
class security_config : public feature_base
{
private:
	static security_config* c_security_config;

public:
	static security_config& instance();

	security_config();

	/**
	 * override of method in feature base. should only be invoked by feature_manager
	 */
