...
public:
	...
	void set_k8s_option(std::string key, std::string value, response_cb_t response_cb);
...
protected:
	...
	struct call_context {
		...
		std::unique_ptr<grpc::ClientAsyncResponseReader<sdc_internal::k8s_option_result>> k8s_option_result_reader;
	};
