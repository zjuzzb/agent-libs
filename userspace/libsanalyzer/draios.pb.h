...
inline const ::std::string& k8s_node::host_ip() const {
  // @@protoc_insertion_point(field_get:draiosproto.k8s_node.host_ip)
  return *host_ip_;
}
inline void k8s_node::set_host_ip(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:draiosproto.k8s_node.host_ip)
}
inline void k8s_node::set_host_ip(const char* value) {
  ...
  host_ip_->assign(value);
  // @@protoc_insertion_point(field_set_char:draiosproto.k8s_node.host_ip)
}
inline void k8s_node::set_host_ip(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:draiosproto.k8s_node.host_ip)
}
inline ::std::string* k8s_node::mutable_host_ip() {
  ...
  // @@protoc_insertion_point(field_mutable:draiosproto.k8s_node.host_ip)
  return host_ip_;
}
...
inline void k8s_node::set_allocated_host_ip(::std::string* host_ip) {
  ...
  // @@protoc_insertion_point(field_set_allocated:draiosproto.k8s_node.host_ip)
}
