...
class network_by_port : public ::google::protobuf::Message {
 public:
  ...
  // optional .draiosproto.connection_categories counters = 2;
  inline bool has_counters() const;
  inline void clear_counters();
  static const int kCountersFieldNumber = 2;
...
inline const ::draiosproto::network_by_port& host::network_by_serverport(int index) const {
  // @@protoc_insertion_point(field_get:draiosproto.host.network_by_serverport)
  return network_by_serverport_.Get(index);
}
inline ::draiosproto::network_by_port* host::mutable_network_by_serverport(int index) {
  // @@protoc_insertion_point(field_mutable:draiosproto.host.network_by_serverport)
  return network_by_serverport_.Mutable(index);
}
inline ::draiosproto::network_by_port* host::add_network_by_serverport() {
  // @@protoc_insertion_point(field_add:draiosproto.host.network_by_serverport)
  return network_by_serverport_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::draiosproto::network_by_port >&
host::network_by_serverport() const {
  // @@protoc_insertion_point(field_list:draiosproto.host.network_by_serverport)
  return network_by_serverport_;
}
inline ::google::protobuf::RepeatedPtrField< ::draiosproto::network_by_port >*
host::mutable_network_by_serverport() {
  // @@protoc_insertion_point(field_mutable_list:draiosproto.host.network_by_serverport)
  return &network_by_serverport_;
}
...
inline const ::draiosproto::network_by_port& container::network_by_serverport(int index) const {
  // @@protoc_insertion_point(field_get:draiosproto.container.network_by_serverport)
  return network_by_serverport_.Get(index);
}
inline ::draiosproto::network_by_port* container::mutable_network_by_serverport(int index) {
  // @@protoc_insertion_point(field_mutable:draiosproto.container.network_by_serverport)
  return network_by_serverport_.Mutable(index);
}
inline ::draiosproto::network_by_port* container::add_network_by_serverport() {
  // @@protoc_insertion_point(field_add:draiosproto.container.network_by_serverport)
  return network_by_serverport_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::draiosproto::network_by_port >&
container::network_by_serverport() const {
  // @@protoc_insertion_point(field_list:draiosproto.container.network_by_serverport)
  return network_by_serverport_;
}
inline ::google::protobuf::RepeatedPtrField< ::draiosproto::network_by_port >*
container::mutable_network_by_serverport() {
  // @@protoc_insertion_point(field_mutable_list:draiosproto.container.network_by_serverport)
  return &network_by_serverport_;
}
...
inline void k8s_service::clear_cluster_ip() {
  if (cluster_ip_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    cluster_ip_->clear();
  }
...
inline ::std::string* k8s_service::release_cluster_ip() {
  ...
  if (cluster_ip_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    cluster_ip_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
