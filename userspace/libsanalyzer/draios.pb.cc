...
void protobuf_AssignDesc_draios_2eproto() {
  ...
  static const int process_offsets_[16] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(process, start_),
  };
  process_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      process_descriptor_,
...
void protobuf_AddDesc_draios_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "rograms\030\t \003(\0132\024.draiosproto.program\0226\n\020i"
    ...
    "t_hidden\030\016 \001(\010\022\030\n\020hidden_processes\030\017 \001(\t"
    ...
    ".proto_info\022*\n\ncontainers\030\026 \003(\0132\026.draios"
    "proto.container\"\232\001\n\022dump_request_start\022\024"
...
const int process::kStartFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 20: {
        ...
        if (input->ExpectTag(168)) goto parse_start;
        break;
      }
...
void process::SerializeWithCachedSizes(
  ...
  // optional uint64 start = 21;
  if (has_start()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(21, this->start(), output);
  }
...
::google::protobuf::uint8* process::SerializeWithCachedSizesToArray(
  ...
  // optional uint64 start = 21;
  if (has_start()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt64ToArray(21, this->start(), target);
  }
