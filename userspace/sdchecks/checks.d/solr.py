...
class Solr(AgentCheck):
    ...
    METRIC_NAME_MAP = {
        ...
        SolrMetrics.METRIC_NAME_ENUM.BROWSE_RPST:                        "solr.browse.request_total",
        SolrMetrics.METRIC_NAME_ENUM.SELECT_RPST:                        "solr.select.request_total",
        SolrMetrics.METRIC_NAME_ENUM.GET_RPST:                           "solr.get.request_total",
        SolrMetrics.METRIC_NAME_ENUM.QUERY_RPST:                         "solr.query.request_total",
        SolrMetrics.METRIC_NAME_ENUM.UPDATE_RPST:                        "solr.update.request_total",
        ...
        SolrMetrics.METRIC_NAME_ENUM.BROWSE_RTT:                         "solr.browse.request_time_total",
        SolrMetrics.METRIC_NAME_ENUM.SELECT_RTT:                         "solr.select.request_time_total",
        SolrMetrics.METRIC_NAME_ENUM.GET_RTT:                            "solr.get.request_time_total",
        SolrMetrics.METRIC_NAME_ENUM.QUERY_RTT:                          "solr.query.request_time_total",
        SolrMetrics.METRIC_NAME_ENUM.UPDATE_RTT:                         "solr.update.request_time_total",
