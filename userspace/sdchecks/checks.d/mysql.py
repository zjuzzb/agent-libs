...
STATUS_VARS = {
    ...
    # Table Lock Metrics
    # reporting locks_waited as rate for backwards compatibility
    'Table_locks_waited': ('mysql.performance.table_locks_waited.gauge', GAUGE),
    'Table_locks_waited_rate': ('mysql.performance.table_locks_waited', RATE),
