...
class ESCheck(AgentCheck):
    ...
    STATS_METRICS = {  # Metrics that are common to all Elasticsearch versions
        ...
        "elasticsearch.docs.growth": ("rate", "indices.docs.count"),
        ...
        "elasticsearch.indexing.index.time.rate": ("rate", "indices.indexing.index_time_in_millis", lambda v: float(v)/1000),
        ...
        "elasticsearch.search.query.time.rate": ("rate", "indices.search.query_time_in_millis", lambda v: float(v)/1000),
        ...
        "elasticsearch.search.fetch.time.rate": ("rate", "indices.search.fetch_time_in_millis", lambda v: float(v)/1000),
