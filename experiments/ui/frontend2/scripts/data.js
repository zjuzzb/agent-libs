function on_data_load(json) {
  ...
  for(var j = 0; j < json.entity_alternatives.length; j++) {
    var alt = json.entity_alternatives[j];
//    objs_list.innerHTML += '<li><a href="#" onclick=\"load_data(\'/data/' + json.entity_name + '/' + tname +'.json\');\">' + tname + '</a></li>';
    objs_list.innerHTML += '<li><a href="#" onclick=\"g_ChartManager.replace_last(\'' + alt.targetdata + '\', \'' + alt.targetchart + '\');\">' + alt.name + '</a></li>';
  }
...
//  g_ChartManager.push('data/urls//updatecart.php/transactions/2.json', g_ChartManager.TYPE_OPLIST);
  g_ChartManager.push('data/url_overview.json', g_ChartManager.TYPE_PIE);
//  g_ChartManager.push('data//overview.json', g_ChartManager.TYPE_PIE);
//  g_ChartManager.replace_last('data/graph.json', g_ChartManager.TYPE_DEPENDENCY_GRAPH);
//  g_ChartManager.push('data/graph.json', g_ChartManager.TYPE_DEPENDENCY_GRAPH);
