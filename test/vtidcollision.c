...
/**
 * Helper for the SMAGENT-1582 integration test
 *
 ...
 *
 *  The bug in SMAGENT-1582 happens because in the above scenario we overwrite the threadinfo
 *  of an unrelated thread which has tid equal to the *vpid* of the final process
 *
 */
