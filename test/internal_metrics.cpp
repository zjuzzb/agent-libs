...
const char* logstr()
{
	return "statsd_metrics {\n"
	       "  name: \"dragent.metricCount.limit.appCheck\"\n"
	       "  type: STATSD_GAUGE\n"
	       "  value: 500\n"
	       "}\n"
	       "statsd_metrics {\n"
	       "  name: \"dragent.metricCount.limit.statsd\"\n"
	       "  type: STATSD_GAUGE\n"
	       "  value: 100\n"
	       "}\n"
	       "statsd_metrics {\n"
	       "  name: \"dragent.metricCount.limit.jmx\"\n"
	       "  type: STATSD_GAUGE\n"
	       "  value: 500\n"
	       "}\n"
	       "statsd_metrics {\n"
	       "  name: \"dragent.metricCount.limit.prometheus\"\n"
	       "  type: STATSD_GAUGE\n"
	       "  value: 3000\n"
	       "}\n"
	       "statsd_metrics {\n"
	       ...
	       "}\n"
	       "statsd_metrics {\n"
	       "  name: \"dragent.analyzer.max_sinsp_buf_used\"\n"
	       "  type: STATSD_GAUGE\n"
	       "  value: 0\n"
	       "}\n"
	       "statsd_metrics {\n"
