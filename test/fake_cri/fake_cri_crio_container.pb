...
exit_code: 0
image {
	image: "docker.io/gnosek/agent:crio"
}
image_ref: "docker.io/gnosek/agent@sha256:5241704b37e01f7bbca0ef6a90f5034731eba85320afd2eb9e4bce7ab09165a2"
labels {
...
mounts {
	...
	host_path: "/var/lib/kubelet/pods/153b7a61-28b4-11e9-afc4-16bf8ef8d9dc/containers/sysdig-agent/e01754de"
	readonly: false
	selinux_relabel: false
	propagation: PROPAGATION_PRIVATE
}
...
mounts {
	container_path: "/opt/draios/etc/kubernetes/config"
	host_path: "/var/lib/kubelet/pods/153b7a61-28b4-11e9-afc4-16bf8ef8d9dc/volumes/kubernetes.io~configmap/sysdig-agent-config"
	readonly: true
	selinux_relabel: false
	propagation: PROPAGATION_PRIVATE
}
mounts {
	container_path: "/opt/draios/etc/kubernetes/secrets"
	host_path: "/var/lib/kubelet/pods/153b7a61-28b4-11e9-afc4-16bf8ef8d9dc/volumes/kubernetes.io~secret/sysdig-agent-secrets"
	readonly: true
	selinux_relabel: false
	propagation: PROPAGATION_PRIVATE
}
mounts {
	...
	host_path: "/var/lib/kubelet/pods/153b7a61-28b4-11e9-afc4-16bf8ef8d9dc/volumes/kubernetes.io~secret/sysdig-agent-token-wl4zl"
	readonly: true
	selinux_relabel: false
	propagation: PROPAGATION_PRIVATE
}
log_path: "/var/log/pods/153b7a61-28b4-11e9-afc4-16bf8ef8d9dc/sysdig-agent/0.log"
}
