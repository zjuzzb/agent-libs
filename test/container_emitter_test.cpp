...
public:
	...
	std::unordered_map<string, vector<thread_analyzer_info*>> progtable;
	std::unordered_map<string, std::shared_ptr<sinsp_container_info>> sinsp_containers;

	// stuff necessary for template
	std::shared_ptr<sinsp_container_info> get_container(const string& container_id)
	{
	...
	static void send_containers_to_statsite_fowarder(
	    ...
	    const unordered_map<string, vector<thread_analyzer_info*>> progtable)
	{
...
TEST(container_emitter, patterns)
{
	...
	fake_analyzer.sinsp_containers["k8s container"] = make_shared<sinsp_container_info>();
	...
	fake_analyzer.sinsp_containers["maybe container 1"] = make_shared<sinsp_container_info>();
	...
	fake_analyzer.sinsp_containers["maybe container 2"] = make_shared<sinsp_container_info>();
...
TEST(container_emitter, end_of_list_fencepost)
{
	...
	fake_analyzer.sinsp_containers["new container"] = make_shared<sinsp_container_info>();
	fake_analyzer.containers["new container2"].m_reported_count = 0;
	fake_analyzer.progtable["new container2"] = {NULL};
	fake_analyzer.sinsp_containers["new container2"] = make_shared<sinsp_container_info>();
	fake_analyzer.containers["new container3"].m_reported_count = 0;
	fake_analyzer.progtable["new container3"] = {NULL};
	fake_analyzer.sinsp_containers["new container3"] = make_shared<sinsp_container_info>();
	fake_analyzer.containers["new container4"].m_reported_count = 0;
	fake_analyzer.progtable["new container4"] = {NULL};
	fake_analyzer.sinsp_containers["new container4"] = make_shared<sinsp_container_info>();
