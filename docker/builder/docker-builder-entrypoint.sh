...
rsync --delete -t -r --exclude=.git --exclude=dependencies --exclude=build --exclude="draiosproto/draios.pb.go" --exclude="sdc_internal/sdc_internal.pb.go" --exclude="promex_pb/promex.pb.go" /draios/agent/ /code/agent/
