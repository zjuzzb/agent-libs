...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] =
{
	...
	/* PPME_SOCKET_ACCEPT_E */{"accept", EC_WAIT, EF_CREATES_FD, 0},
	/* PPME_SOCKET_ACCEPT_X */{"accept", EC_WAIT, EF_CREATES_FD, 3, {{"fd", PT_FD, PF_DEC}, {"tuple", PT_SOCKTUPLE, PF_NA}, {"queuepct", PT_UINT8, PF_DEC}}},
