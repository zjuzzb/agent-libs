...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] =
{
	...
	/* PPME_SYSCALL_DUP_E */{"dup", EC_IO_OTHER, (ppm_event_flags)(EF_CREATES_FD | EF_USES_FD), 1, {{"fd", PT_FD, PF_DEC}}},
	/* PPME_SYSCALL_DUP_X */{"dup", EC_IO_OTHER, (ppm_event_flags)(EF_CREATES_FD | EF_USES_FD), 1, {{"res", PT_FD, PF_DEC}}},
