...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] =
{
	...
	/* PPME_PROCEXIT_E */{"procexit", EC_SCHEDULER, EF_NONE, 0},
	/* PPME_NA1 */{"NA1", EC_SCHEDULER, EF_NONE, 0},
	...
	/* PPME_SOCKET_SENDMSG_E */{"sendmsg", EC_IO_WRITE, EF_NONE, 0},
	/* PPME_SOCKET_SENDMSG_X */{"sendmsg", EC_IO_WRITE, EF_NONE, 0},
	/* PPME_SOCKET_SENDMMSG_E */{"sendmmsg", EC_IO_WRITE, EF_NONE, 0},
	/* PPME_SOCKET_SENDMMSG_X */{"sendmmsg", EC_IO_WRITE, EF_NONE, 0},
	/* PPME_SOCKET_RECVMSG_E */{"recvmsg", EC_IO_READ, EF_NONE, 0},
	/* PPME_SOCKET_RECVMSG_X */{"recvmsg", EC_IO_READ, EF_NONE, 0},
	...
	/* PPME_SCHEDSWITCH_E */{"switch", EC_SCHEDULER, EF_NONE, 0},
