...
const struct syscall_evt_pair g_syscall_table[SYSCALL_TABLE_SIZE] =
{
	...
	[__NR_epoll_wait] = 	{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_EPOLLWAIT_E, PPME_SYSCALL_EPOLLWAIT_X},
	[__NR_poll] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_POLL_E, PPME_SYSCALL_POLL_X},
	[__NR_select] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_SELECT_E, PPME_SYSCALL_SELECT_X},
	...
	[__NR_kill] = 			{UF_NORMAL_MODE, PPME_SYSCALL_KILL_E, PPME_SYSCALL_KILL_X},
	[__NR_tkill] =	 		{UF_NORMAL_MODE, PPME_SYSCALL_TKILL_E, PPME_SYSCALL_TKILL_X},
	[__NR_tgkill] = 		{UF_NORMAL_MODE, PPME_SYSCALL_TGKILL_E, PPME_SYSCALL_TGKILL_X},
...
//	[__NR_old_select] = 	{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
	[__NR_pselect6] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
