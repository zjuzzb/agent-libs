...
{
#ifdef __NR_open
	[__NR_open] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_OPEN_E, PPME_SYSCALL_OPEN_X},
#endif
#ifdef __NR_creat
	[__NR_creat] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_CREAT_E, PPME_SYSCALL_CREAT_X},
#endif
#ifdef __NR_close
	[__NR_close] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_CLOSE_E, PPME_SYSCALL_CLOSE_X},
#endif
#ifdef __NR_brk
	[__NR_brk] = 			{UF_NORMAL_MODE, PPME_SYSCALL_BRK_E, PPME_SYSCALL_BRK_X},
#endif
#ifdef __NR_read
	[__NR_read] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_READ_E, PPME_SYSCALL_READ_X},
#endif
#ifdef __NR_write
	[__NR_write] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_WRITE_E, PPME_SYSCALL_WRITE_X},
#endif
#ifdef __NR_execve
	[__NR_execve] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_EXECVE_E, PPME_SYSCALL_EXECVE_X},
#endif
#ifdef __NR_clone
	[__NR_clone] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_CLONE_E, PPME_CLONE_X},
#endif
//	[__NR_exit] = 			{UF_NORMAL_MODE, PPME_SYSCALL_EXIT_E, PPME_SYSCALL_EXIT_EXIT},
//	[__NR_socketcall] = 	{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_EXIT},
#ifdef __NR_pipe
	[__NR_pipe] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_PIPE_E, PPME_SYSCALL_PIPE_X},
#endif
#ifdef __NR_pipe2
	[__NR_pipe2] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_PIPE_E, PPME_SYSCALL_PIPE_X},
#endif
#ifdef __NR_eventfd
	[__NR_eventfd] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_EVENTFD_E, PPME_SYSCALL_EVENTFD_X},
#endif
#ifdef __NR_eventfd2
	[__NR_eventfd2] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_EVENTFD_E, PPME_SYSCALL_EVENTFD_X},
#endif
#ifdef __NR_futex
	[__NR_futex] = 			{UF_NORMAL_MODE, PPME_SYSCALL_FUTEX_E, PPME_SYSCALL_FUTEX_X},
#endif
#ifdef __NR_stat
	[__NR_stat] = 			{UF_NORMAL_MODE, PPME_SYSCALL_STAT_E, PPME_SYSCALL_STAT_X},
#endif
#ifdef __NR_lstat
	[__NR_lstat] = 			{UF_NORMAL_MODE, PPME_SYSCALL_LSTAT_E, PPME_SYSCALL_LSTAT_X},
#endif
#ifdef __NR_fstat
	[__NR_fstat] = 			{UF_NORMAL_MODE, PPME_SYSCALL_FSTAT_E, PPME_SYSCALL_FSTAT_X},
#endif
#ifdef __NR_epoll_wait
	[__NR_epoll_wait] = 	{UF_NORMAL_MODE, PPME_SYSCALL_EPOLLWAIT_E, PPME_SYSCALL_EPOLLWAIT_X},
#endif
#ifdef __NR_poll
	[__NR_poll] = 			{UF_NORMAL_MODE, PPME_SYSCALL_POLL_E, PPME_SYSCALL_POLL_X},
#endif
#ifdef __NR_select
	[__NR_select] = 		{UF_NORMAL_MODE, PPME_SYSCALL_SELECT_E, PPME_SYSCALL_SELECT_X},
#endif
#ifdef __NR_lseek
	[__NR_lseek] = 			{UF_NORMAL_MODE, PPME_SYSCALL_LSEEK_E, PPME_SYSCALL_LSEEK_X},
#endif
#ifdef __NR_ioctl
	[__NR_ioctl] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_IOCTL_E, PPME_SYSCALL_IOCTL_X},
#endif
#ifdef __NR_getcwd
	[__NR_getcwd] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_GETCWD_E, PPME_SYSCALL_GETCWD_X},
#endif
#ifdef __NR_chdir
	[__NR_chdir] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_CHDIR_E, PPME_SYSCALL_CHDIR_X},
#endif
#ifdef __NR_fchdir
	[__NR_fchdir] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_FCHDIR_E, PPME_SYSCALL_FCHDIR_X},
#endif
#ifdef __NR_mkdir
	[__NR_mkdir] = 			{UF_NORMAL_MODE, PPME_SYSCALL_MKDIR_E, PPME_SYSCALL_MKDIR_X},
#endif
#ifdef __NR_rmdir
	[__NR_rmdir] = 			{UF_NORMAL_MODE, PPME_SYSCALL_RMDIR_E, PPME_SYSCALL_RMDIR_X},
#endif
#ifdef __NR_openat
	[__NR_openat] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_OPENAT_E, PPME_SYSCALL_OPENAT_X},
#endif
#ifdef __NR_link
	[__NR_link] = 			{UF_NORMAL_MODE, PPME_SYSCALL_LINK_E, PPME_SYSCALL_LINK_X},
#endif
#ifdef __NR_linkat
	[__NR_linkat] = 		{UF_NORMAL_MODE, PPME_SYSCALL_LINKAT_E, PPME_SYSCALL_LINKAT_X},
#endif
#ifdef __NR_unlink
	[__NR_unlink] = 		{UF_NORMAL_MODE, PPME_SYSCALL_UNLINK_E, PPME_SYSCALL_UNLINK_X},
#endif
#ifdef __NR_unlinkat
	[__NR_unlinkat] = 		{UF_NORMAL_MODE, PPME_SYSCALL_UNLINKAT_E, PPME_SYSCALL_UNLINKAT_X},
#endif
#ifdef __NR_pread64
	[__NR_pread64] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_PREAD_E, PPME_SYSCALL_PREAD_X},
#endif
#ifdef __NR_pwrite64
	[__NR_pwrite64] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_PWRITE_E, PPME_SYSCALL_PWRITE_X},
#endif
#ifdef __NR_readv
	[__NR_readv] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_READV_E, PPME_SYSCALL_READV_X},
#endif
#ifdef __NR_writev
	[__NR_writev] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_WRITEV_E, PPME_SYSCALL_WRITEV_X},
#endif
#ifdef __NR_preadv
	[__NR_preadv] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_PREADV_E, PPME_SYSCALL_PREADV_X},
#endif
#ifdef __NR_pwritev
	[__NR_pwritev] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_PWRITEV_E, PPME_SYSCALL_PWRITEV_X},
#endif
#ifdef __NR_dup
	[__NR_dup] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_DUP_E, PPME_SYSCALL_DUP_X},
#endif
#ifdef __NR_dup2
	[__NR_dup2] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_DUP_E, PPME_SYSCALL_DUP_X},
#endif
#ifdef __NR_dup3
	[__NR_dup3] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_DUP_E, PPME_SYSCALL_DUP_X},
#endif
#ifdef __NR_signalfd
	[__NR_signalfd] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_SIGNALFD_E, PPME_SYSCALL_SIGNALFD_X},
#endif
#ifdef __NR_signalfd4
	[__NR_signalfd4] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_SIGNALFD_E, PPME_SYSCALL_SIGNALFD_X},
#endif
#ifdef __NR_kill
	[__NR_kill] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_KILL_E, PPME_SYSCALL_KILL_X},
#endif
#ifdef __NR_tkill
	[__NR_tkill] =	 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_TKILL_E, PPME_SYSCALL_TKILL_X},
#endif
#ifdef __NR_tgkill
	[__NR_tgkill] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_TGKILL_E, PPME_SYSCALL_TGKILL_X},
#endif
#ifdef __NR_nanosleep
	[__NR_nanosleep] = 		{UF_NORMAL_MODE, PPME_SYSCALL_NANOSLEEP_E, PPME_SYSCALL_NANOSLEEP_X},
#endif
#ifdef __NR_timerfd_create
	[__NR_timerfd_create] =	{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_TIMERFD_CREATE_E, PPME_SYSCALL_TIMERFD_CREATE_X},
#endif
#ifdef __NR_inotify_init
	[__NR_inotify_init] =	{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_INOTIFY_INIT_E, PPME_SYSCALL_INOTIFY_INIT_X},
#endif
#ifdef __NR_inotify_init1
	[__NR_inotify_init1] =	{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_INOTIFY_INIT_E, PPME_SYSCALL_INOTIFY_INIT_X},
#endif
#ifdef __NR_getrlimit
	[__NR_getrlimit] =		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_GETRLIMIT_E, PPME_SYSCALL_GETRLIMIT_X},
#endif
#ifdef __NR_setrlimit
	[__NR_setrlimit] =		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_SETRLIMIT_E, PPME_SYSCALL_SETRLIMIT_X},
#endif
#ifdef __NR_prlimit64
	[__NR_prlimit64] =		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_PRLIMIT_E, PPME_SYSCALL_PRLIMIT_X},
#endif
#ifdef __NR_ugetrlimit
	[__NR_ugetrlimit] =		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SYSCALL_GETRLIMIT_E, PPME_SYSCALL_GETRLIMIT_X},
#endif
#ifdef __NR_ppoll 
//	[__NR_ppoll] = 			{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_old_select 
//	[__NR_old_select] = 	{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_pselect6
	[__NR_pselect6] = 		{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_epoll_create
	[__NR_epoll_create] =	{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_epoll_ctl
	[__NR_epoll_ctl] =		{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_uselib
	[__NR_uselib] = 		{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_sched_setparam
	[__NR_sched_setparam] = {UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_sched_getparam
	[__NR_sched_getparam] = {UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_fork
	[__NR_fork] = 			{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_syslog
	[__NR_syslog] = 		{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_chmod
	[__NR_chmod] = 			{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_lchown
	[__NR_lchown] = 		{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_utime
	[__NR_utime] = 			{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_mount
	[__NR_mount] = 			{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_umount2
	[__NR_umount2] = 		{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_setuid
	[__NR_setuid] = 		{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_getuid
	[__NR_getuid] = 		{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_ptrace
	[__NR_ptrace] = 		{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_alarm
	[__NR_alarm] = 			{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_pause
	[__NR_pause] = 			{UF_NORMAL_MODE, PPME_GENERIC_E, PPME_GENERIC_X},
#endif
#ifdef __NR_socket
	[__NR_socket] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SOCKET_SOCKET_E, PPME_SOCKET_SOCKET_X},
#endif
#ifdef __NR_bind
	[__NR_bind] = 			{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SOCKET_BIND_E,  PPME_SOCKET_BIND_X},
#endif
#ifdef __NR_connect
	[__NR_connect] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SOCKET_CONNECT_E, PPME_SOCKET_CONNECT_X},
#endif
#ifdef __NR_listen
	[__NR_listen] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SOCKET_LISTEN_E, PPME_SOCKET_LISTEN_X},
#endif
#ifdef __NR_accept
	[__NR_accept] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SOCKET_ACCEPT_E, PPME_SOCKET_ACCEPT_X},
#endif
#ifdef __NR_getsockname
	[__NR_getsockname] = 	{UF_NORMAL_MODE, PPME_SOCKET_GETSOCKNAME_E, PPME_SOCKET_GETSOCKNAME_X},
#endif
#ifdef __NR_getpeername
	[__NR_getpeername] = 	{UF_NORMAL_MODE, PPME_SOCKET_GETPEERNAME_E, PPME_SOCKET_GETPEERNAME_X},
#endif
#ifdef __NR_socketpair
	[__NR_socketpair] = 	{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SOCKET_SOCKETPAIR_E, PPME_SOCKET_SOCKETPAIR_X},
#endif
#ifdef __NR_sendto
	[__NR_sendto] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SOCKET_SENDTO_E, PPME_SOCKET_SENDTO_X},
#endif
#ifdef __NR_recvfrom
	[__NR_recvfrom] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SOCKET_RECVFROM_E, PPME_SOCKET_RECVFROM_X},
#endif
#ifdef __NR_shutdown
	[__NR_shutdown] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SOCKET_SHUTDOWN_E, PPME_SOCKET_SHUTDOWN_X},
#endif
#ifdef __NR_setsockopt
	[__NR_setsockopt] = 	{UF_NORMAL_MODE, PPME_SOCKET_SETSOCKOPT_E, PPME_SOCKET_SETSOCKOPT_X},
#endif
#ifdef __NR_getsockopt
	[__NR_getsockopt] = 	{UF_NORMAL_MODE, PPME_SOCKET_GETSOCKOPT_E, PPME_SOCKET_GETSOCKOPT_X},
#endif
#ifdef __NR_sendmsg
	[__NR_sendmsg] = 		{UF_NORMAL_MODE, PPME_SOCKET_SENDMSG_E, PPME_SOCKET_SENDMSG_X},
#endif
#ifdef __NR_sendmmsg
	[__NR_sendmmsg] = 		{UF_NORMAL_MODE, PPME_SOCKET_SENDMMSG_E, PPME_SOCKET_SENDMMSG_X},
#endif
#ifdef __NR_recvmsg
	[__NR_recvmsg] = 		{UF_NORMAL_MODE, PPME_SOCKET_RECVMSG_E, PPME_SOCKET_RECVMSG_X},
#endif
#ifdef __NR_recvmmsg
	[__NR_recvmmsg] = 		{UF_NORMAL_MODE, PPME_SOCKET_RECVMMSG_E, PPME_SOCKET_RECVMMSG_X},
#endif
#ifdef __NR_accept4
	[__NR_accept4] = 		{UF_NORMAL_MODE | UF_DROPPING_MODE, PPME_SOCKET_ACCEPT4_E, PPME_SOCKET_ACCEPT4_X},
#endif
#ifdef __NR_stat64
	[__NR_stat64] = 		{UF_NORMAL_MODE, PPME_SYSCALL_STAT64_E, PPME_SYSCALL_STAT64_X},
#endif
#ifdef __NR_fstat64
	[__NR_fstat64] = 		{UF_NORMAL_MODE, PPME_SYSCALL_FSTAT64_E, PPME_SYSCALL_FSTAT64_X},
#endif
#ifdef __NR__llseek
	[__NR__llseek] = 		{UF_NORMAL_MODE, PPME_SYSCALL_LLSEEK_E, PPME_SYSCALL_LLSEEK_X}
#endif
};
